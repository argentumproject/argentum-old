...
// to be replayed on top of the ARGENTUM genesis block.
static
struct {
...
{
    // changed this to argentum genesis pubkey script
    ...
    BOOST_CHECK(pblocktemplate = CreateNewBlock(scriptPubKey, miningAlgo));
