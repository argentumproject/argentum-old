...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"argentumaddress\"\n"
            "\nReturn information about the given argentum address.\n"
            "\nArguments:\n"
            "1. \"argentumaddress\"     (string, required) The argentum address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"argentumaddress\", (string) The argentum address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Argentum address and we have full public key:
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"argentumaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"argentumaddress\"  (string, required) The argentum address to use for the signature.\n"
