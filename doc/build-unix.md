UNIX BUILD NOTES
====================
Some notes on how to build Argentum in Unix. 
...
This will build argentum-qt as well if the dependencies are met.
...
memory available when compiling Argentum Core. With 512MB of memory or less
...
If you want to build Argentum-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a argentum-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip argentumd" to strip the debug
...
cryptography functions, and therefore cannot be used for Argentum (or other
...
Security
--------
To help make your argentum installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, argentum should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, argentum may be compiled in
